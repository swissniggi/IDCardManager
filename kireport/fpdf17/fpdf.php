...
* License:  LGPL                                                               *
* **************************************************************************** *
* Anpassungen Lukas Buchs, kipferinformatik.ch                                 *
* - Relative Pfade in Temp.Dateien, separates Verzeichnis                      *
* - Public / Protected Funktionen                                              *
*******************************************************************************/

define('FPDF_VERSION','1.7');
define('tFPDF_VERSION','1.24.1');
...
class FPDF {
    ...
    *******************************************************************************/
    ...
    public function AddFont($family, $style='', $file='', $uni=false) {
        ...
        if ($uni) {
            ...
            $unifilename = $this->_getfontpath().'unifont/generated/'.strtolower(substr($file ,0,(strpos($file ,'.'))));
            $name = '';
            $originalsize = 0;
            ...
            if (file_exists($unifilename.'.mtx.php')) {
                ...
                if (isset($ttffile)) {
                    $ttffile = $this->_getfontpath() . $ttffile;
                }
            }
            if (!isset($type) ||  !isset($name) || $originalsize != $ttfstat['size']) {
                ...
                'MissingWidth'=>round($ttf->defaultWidth*2));
                ...
                $s.='$up='.$up.";\n";
                $s.='$ut='.$ut.";\n";
                $s.='$ttffile=\''.'unifont/'.$file."';\n"; // Anpassung: Wir schreiben relative Pfade denn wir sind cool :-)
                ...
                if (file_exists($unifilename.'.cw.dat')) {
                    ...
                    throw new Exception('.cw.dat der Schriftart '.$family.' nicht gefunden. '.$unifilename.'.mtx.php löschen, um sie neu zu generieren.');
                }
            }
    ...
    *******************************************************************************/
    ...
    protected function _putinfo() {
        $this->_out('/Producer '.$this->_textstring('SocialOffice/tFPDF '.tFPDF_VERSION));
        if (!empty($this->title))
